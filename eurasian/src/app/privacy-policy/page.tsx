  ...
  return (
    <div className="privacy-policy-container">
      ...
      <Card className="card-shadow">
        <CardHeader>
          <CardTitle className="card-title-headline">1. Introduction</CardTitle>
        </CardHeader>
      ...
      <Card className="card-shadow">
        <CardHeader>
          <CardTitle className="card-title-headline">2. Information We Collect</CardTitle>
        </CardHeader>
        <CardContent className="card-content-spaced">
          <p>
      ...
      <Card className="card-shadow">
        <CardHeader>
          <CardTitle className="card-title-headline">3. How We Use Your Information</CardTitle>
        </CardHeader>
        <CardContent className="card-content-spaced">
          ...
          <ul className="list-disc list-inside list-spaced">
      ...
      <Card className="card-shadow">
        <CardHeader>
          <CardTitle className="card-title-headline">4. Will Your Information Be Shared With Anyone?</CardTitle>
        </CardHeader>
        <CardContent className="card-content-spaced">
      ...
      <Card className="card-shadow">
        <CardHeader>
          <CardTitle className="card-title-headline">5. How Long Do We Keep Your Information?</CardTitle>
        </CardHeader>
        <CardContent className="card-content-spaced">
      ...
      <Card className="card-shadow">
        <CardHeader>
          <CardTitle className="card-title-headline">6. How Do We Keep Your Information Safe?</CardTitle>
        </CardHeader>
        <CardContent className="card-content-spaced">
      ...
      <Card className="card-shadow">
        <CardHeader>
          <CardTitle className="card-title-headline">7. Contact Us</CardTitle>
        </CardHeader>
        <CardContent className="card-content-spaced">
