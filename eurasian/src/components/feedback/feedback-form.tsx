...
export default function FeedbackForm() {
  ...
  return (
    <Card className="feedback-card">
      <CardHeader>
        <CardTitle className="feedback-title">Submit Feedback</CardTitle>
        <CardDescription className="feedback-desc">
          We value your input! Help us improve SecureBase.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form action={formAction} className="feedback-form">
          <div className="feedback-field">
            ...
            {getErrorForField("email") && (
              <p id="email-error" className="feedback-error">
                {getErrorForField("email")}
              </p>
            )}
          </div>
          ...
          <div className="feedback-field">
            ...
            {getErrorForField("feedbackType") && (
              <p id="feedbackType-error" className="feedback-error">
                {getErrorForField("feedbackType")}
              </p>
            )}
          </div>
          ...
          <div className="feedback-field">
            ...
            {getErrorForField("message") && (
              <p id="message-error" className="feedback-error">
                {getErrorForField("message")}
              </p>
            )}
          </div>
          ...
          {state?.error && !state.issues?.length && (
            <p className="feedback-error">{state.error}</p>
          )}
          {state?.message && !state.error && (
            <p className="feedback-success">{state.message}</p>
          )}
